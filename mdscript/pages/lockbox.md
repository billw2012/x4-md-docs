...
|------|------|-------------|
| `rarity` | [`integer`](./integer.html) | Rarity of the lockbox |
| `locks.<state>.count` | [`integer`](./integer.html) | Number of locks on this lockbox, filtered by component state: all, construction, operational or wreck |
| `locks.<state>.list` | [`list`](./list.html) | List of locks on this lockbox, filtered by component state: all, construction, operational or wreck |
| `locks.<state>.random` | [`lock`](./lock.html) | Random lock on this lockbox, filtered by component state: all, construction, operational or wreck |
