...
| `targetslot` | [`componentslot`](./componentslot.html) | The slot currently set as the next target for a moving NPC. The NPC may not be at this offset but in-transit to it. (component may be a room or object) |
| `currentchair` | [`componentslot`](./componentslot.html) | The chair slot the NPC is currently inhabiting. Not set when moving towards the chair. (component may be a room or object) |
| `hasclothingmod` | [`boolean`](./boolean.html) | Whether the NPC has any clothing mod installed |
