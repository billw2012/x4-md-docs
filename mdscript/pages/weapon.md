...
| `ammo.macro` | [`macro`](./macro.html) | Macro of the used ammo |
| `ammo.ware` | [`ware`](./ware.html) | Ware that can provide the used ammomacro |
| `ammo.iscompatible.{$macro}` | [`boolean`](./boolean.html) | true iff the supplied ammo macro (missile) is compatible with this weapon |
| `isreadytofire` | [`boolean`](./boolean.html) | Is ready to fire (weapon active, turret deployed) |
| `mode` | [`weaponmode`](./weaponmode.html) | mode this weapon/turret is operating in |
| `isrepairing` | [`boolean`](./boolean.html) | Whether the weapon is for repairing |
