...
##  [`resourceprobe`](./resourceprobe.html)  [`object`](./object.html)  [`destructible`](./destructible.html)  [`component`](./component.html) 
...
|------|------|-------------|
| `currentbestyield.{$ware}` | [`integer`](./integer.html) | The current best yield for a specific ware detected by the resource probe (volume is a cube of space with a side length of 32km) |
| `currentyield` | [`wareamountlist`](./wareamountlist.html) | The current total yield detected by the resource probe (volume is a cube of space with a side length of 32km) |
| `maxyield` | [`wareamountlist`](./wareamountlist.html) | The maximum undepleted yield detected by the resource probe (volume is a cube of space with a side length of 32km) |
