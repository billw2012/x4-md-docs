...
|------|------|-------------|
| `isproducing` | [`boolean`](./boolean.html) | true iff producing |
| `ispaused` | [`boolean`](./boolean.html) | true iff paused for any reason (hacked, manually, damaged...) |
| `ispausedmanually` | [`boolean`](./boolean.html) | true iff paused manually (see also: <set_production_paused />) |
| `iswaitingforresources` | [`boolean`](./boolean.html) | true if the production module is currently waiting for resources to start |
| `iswaitingforstorage` | [`boolean`](./boolean.html) | true if the production module is currently waiting for storage space for products |
| `products` | [`warelist`](./warelist.html) | All produced wares |
| `research` | [`warelist`](./warelist.html) | All research wares currently being worked on by this module |
