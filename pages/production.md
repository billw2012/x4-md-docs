...
| `isproducing` | [`boolean`](./boolean.html) | true iff producing | (this) |
| `ispaused` | [`boolean`](./boolean.html) | true iff paused for any reason (hacked, manually, damaged...) | (this) |
| `ispausedmanually` | [`boolean`](./boolean.html) | true iff paused manually (see also: <set_production_paused />) | (this) |
| `iswaitingforresources` | [`boolean`](./boolean.html) | true if the production module is currently waiting for resources to start | (this) |
| `iswaitingforstorage` | [`boolean`](./boolean.html) | true if the production module is currently waiting for storage space for products | (this) |
| `products` | [`warelist`](./warelist.html) | All produced wares | (this) |
| `research` | [`warelist`](./warelist.html) | All research wares currently being worked on by this module | (this) |
| `resources` | [`warelist`](./warelist.html) | All resource wares | (this) |
