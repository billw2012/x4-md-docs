...
| `hasentrypos` | [`boolean`](./boolean.html) | true iff position for dock area entry is defined | (this) |
| `entrypos` | [`position`](./position.html) | Dock area entry position | (this) |
| `hasexitpos` | [`boolean`](./boolean.html) | true iff position for dock area exit is defined | (this) |
| `exitpos` | [`position`](./position.html) | Dock area exit position | (this) |
| `numdocks.{$docksize}` | [`integer`](./integer.html) | Number of connected dockingbays supporting the specified docksize | (this) |
