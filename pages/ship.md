...
| `todockpositionreverse.{$dockingbay}` | [`position`](./position.html) | The positional offset to the backwards facing todock position relative to the ship's current position | (this) |
| `todockrotationreverse.{$dockingbay}` | [`rotation`](./rotation.html) | The rotational offset to the backwards facing todock position relative to the ship's current orientation | (this) |
| `hidecargochance` | [`float`](./float.html) | Chance that illegal or valuable cargo on board is successfully hidden from scans (0-100, higher is better) | (this) |
| `maxspeed` | [`length`](./length.html) | Maximum speed with present engine set up and conditions (in m/s) | (this) |
| `maxyawspeed` | [`angle`](./angle.html) | Maximum rate of change in yaw with present engine set up and conditions (in rad/s) | (this) |
| `maxpitchspeed` | [`angle`](./angle.html) | Maximum rate of change in pitch with present engine set up and conditions (in rad/s) | (this) |
| `maxrollspeed` | [`angle`](./angle.html) | Maximum rate of change in roll with present engine set up and conditions (in rad/s) | (this) |
| `speedlimit` | [`length`](./length.html) | The speed limit currently imposed by the ship's environment (in m/s, -1 if there is none) | (this) |
| `canenterhighway` | [`boolean`](./boolean.html) | True iff this ship is capable of entering highways | (this) |
| `parkedat` | [`destructible`](./destructible.html) | Tradeoffer component that this ship is parked at (= has parking connection to) | (this) |
| `pickedupobject` | [`object`](./object.html) | The object which is currently being carried by this ship | (this) |
| `regiondamageprotection` | [`float`](./float.html) | Amount of protection against static environmental damage (0-100, higher is better) | (this) |
| `job` | [`string`](./string.html) | job ID | (this) |
| `jobname` | [`string`](./string.html) | job name | (this) |
| `isjobship` | [`boolean`](./boolean.html) | true if this is a job ship | (this) |
| `isrequestedjobship` | [`boolean`](./boolean.html) | true if this is a requested job ship | (this) |
| `jobexpired` | [`boolean`](./boolean.html) | true if this is a non-commandeered job ship which has passed its expiration time | (this) |
| `jobcommander` | [`ship`](./ship.html) | the original ship which this ship was set to call commander (may have changed) | (this) |
| `jobmainsector` | [`sector`](./sector.html) | the sector this ship is set to perform in or start from | (this) |
| `jobmainzone` | [`zone`](./zone.html) | the zone this ship is set to perform in or start from | (this) |
| `isvalidjobspace.{$space}` | [`boolean`](./boolean.html) | is the provided space currently valid according to the job definition of this ship | (this) |
| `jobsubordinates.valid` | [`list`](./list.html) | List of subordinates who's place in the hierarchy is valid according to the job definition of this ship | (this) |
| `jobsubordinates.invalid` | [`list`](./list.html) | List of subordinates who's place in the hierarchy is not valid according to the job definition of this ship | (this) |
| `encounterid` | [`string`](./string.html) | Encounter type ID defined by this ship's job | (this) |
| `isencountership` | [`boolean`](./boolean.html) | true if this is a ship for encounters | (this) |
| `warebasket` | [`warelist`](./warelist.html) | Wares in job ship basket | (this) |
| `constructionmodule` | [`buildmodule`](./buildmodule.html) | Build module which this construction vessel is assigned to be deployed at | (this) |
| `isdeployedconstructionvessel` | [`boolean`](./boolean.html) | true if this ship is a construction vessel currently deployed at their 'constructionmodule' | (this) |
| `iscapitalship` | [`boolean`](./boolean.html) | true if this is a capital ship (size L or XL) | (this) |
| `islasertower` | [`boolean`](./boolean.html) | true iff the ship is a lasertower | (this) |
| `hasshipmod` | [`boolean`](./boolean.html) | Whether the object has any ship mod installed | (this) |
| `hasshipmod.{$ware}` | [`boolean`](./boolean.html) | Whether the object has a ship mod based on the specified ship mod ware installed | (this) |
| `canbeclaimed` | [`boolean`](./boolean.html) | Whether the ship is currently in a claimable state | (this) |
| `defaultformationradius.{$ship}` | [`length`](./length.html) | The appropriate formation radius for this ship and its formation leader($ship) | (this) |
| `issupplyship` | [`boolean`](./boolean.html) | True if this ship is capable of re-supplying other ships, i.e. it can repair ships and equipment or produce ammo/units (see also .cansupplyships) but cannot build equipment or ships from scratch | (this) |
| `movementrefobject` | [`object`](./object.html) | The object this ship is currently moving relative to | (this) |
| `activeweapongroup.primary` | [`integer`](./integer.html) | The currently active primary weapon group | (this) |
| `activeweapongroup.secondary` | [`integer`](./integer.html) | The currently active secondary weapon group | (this) |
| `environment` | [`component`](./component.html) | Component which this ship is currently physically inside, but not necessarily connected to (limited to specific components, usually dock areas and build modules) | (this) |
| `cantowobjects` | [`boolean`](./boolean.html) | true iff this ship is capable of towing objects | (this) |
| `towedobject` | [`object`](./object.html) | the object this ship is towing | (this) |
| `takesregiondamage` | [`boolean`](./boolean.html) | true if this ship is susceptible to region damage | (this) |
