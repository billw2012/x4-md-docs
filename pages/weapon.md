...
| `ammo.capacity` | [`integer`](./integer.html) | Amount of ammostorage this weapon adds to its destructible | (this) |
| `ammo.macro` | [`macro`](./macro.html) | Macro of the used ammo | (this) |
| `ammo.ware` | [`ware`](./ware.html) | Ware that can provide the used ammomacro | (this) |
| `ammo.iscompatible.{$macro}` | [`boolean`](./boolean.html) | true iff the supplied ammo macro (missile) is compatible with this weapon | (this) |
| `isreadytofire` | [`boolean`](./boolean.html) | Is ready to fire (weapon active, turret deployed) | (this) |
| `mode` | [`weaponmode`](./weaponmode.html) | mode this weapon/turret is operating in | (this) |
| `isrepairing` | [`boolean`](./boolean.html) | Whether the weapon is for repairing | (this) |
| `ismining` | [`boolean`](./boolean.html) | Whether the weapon is for mining | (this) |
| `iscombat` | [`boolean`](./boolean.html) | Whether the weapon is neither for repairing nor for mining | (this) |
| `barrelposition` | [`position`](./position.html) | The position of the weapon's barrel (may be 0,0,0 for weapons with no collision) | (this) |
