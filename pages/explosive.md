...
| `isguided` | [`boolean`](./boolean.html) | true if this explosive is guided | (this) |
| `countermeasureresistance.{$macro}` | [`float`](./float.html) | percentage change of this explosive resisting the effects of the provided countermeasure macro | (this) |
