...
| `isfunctional` | [`boolean`](./boolean.html) | true iff the object exists in the game graph and is functional | (this) |
| `ishackable` | [`boolean`](./boolean.html) | true iff the object can be hacked | (this) |
| `ishacked` | [`boolean`](./boolean.html) | true iff the object is currently hacked | (this) |
| `isindestructible` | [`boolean`](./boolean.html) | true iff object has hull, is not invulnerable, and has a minimum hull value of 0 | (this) |
| `ishullunrepairable` | [`boolean`](./boolean.html) | true iff object has hull and hull is set to unrepairable | (this) |
| `isrepairable` | [`boolean`](./boolean.html) | true iff the object is operational but may be repaired | (this) |
| `isinvulnerable` | [`boolean`](./boolean.html) | true iff the object has permanently invulnerable hull or shields | (this) |
| `isshieldunrepairable` | [`boolean`](./boolean.html) | true iff object has shields and shield is set to unrepairable | (this) |
| `hull` | [`hitpoints`](./hitpoints.html) | Hull value | (this) |
| `maxhull` | [`hitpoints`](./hitpoints.html) | Max hull value | (this) |
| `hullpercentage` | [`float`](./float.html) | Hull value percentage | (this) |
| `shield` | [`hitpoints`](./hitpoints.html) | Shield value | (this) |
| `maxshield` | [`hitpoints`](./hitpoints.html) | Max shield value | (this) |
| `shieldpercentage` | [`float`](./float.html) | Shield value percentage | (this) |
| `drop` |  | Drop ID | (this) |
| `hasstorage` | [`boolean`](./boolean.html) | true iff there is a functional storage module | (this) |
| `canclaimownership` | [`boolean`](./boolean.html) | true iff this object can claim ownership of a sector | (this) |
| `modulesets` | [`list`](./list.html) | List of module set strings | (this) |
| `makerraces` | [`list`](./list.html) | Maker race list | (this) |
| `primarypurpose` | [`purpose`](./purpose.html) | The object's primary purpose | (this) |
| `threatscore` | [`float`](./float.html) | The object's threat score, either defined by its macro or by defaults based on its primary purpose | (this) |
