...
| `ispersistent` | [`boolean`](./boolean.html) | Is the navcontext is set to be persistent? If true, the interior can exist in low attentions. | (this) |
| `isprivate` | [`boolean`](./boolean.html) | Is the navcontext is set to private? If true, contained NPC slots can only be found by directly querying the contained rooms | (this) |
| `rooms` | [`list`](./list.html) | Contained rooms of the navcontext | (this) |
