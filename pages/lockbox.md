...
| `rarity` | [`integer`](./integer.html) | Rarity of the lockbox | (this) |
| `locks.<state>.count` | [`integer`](./integer.html) | Number of locks on this lockbox, filtered by component state: all, construction, operational or wreck | (this) |
| `locks.<state>.list` | [`list`](./list.html) | List of locks on this lockbox, filtered by component state: all, construction, operational or wreck | (this) |
| `locks.<state>.random` | [`lock`](./lock.html) | Random lock on this lockbox, filtered by component state: all, construction, operational or wreck | (this) |
