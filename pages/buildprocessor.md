...
| `buildmodule` | [`buildmodule`](./buildmodule.html) | build module containing this build processor | (this) |
| `isbusy` | [`boolean`](./boolean.html) | true iff building | (this) |
| `isbuilding` | [`boolean`](./boolean.html) | true iff building | (this) |
| `elapsedtime` | [`time`](./time.html) | Elapsed time | (this) |
| `elapsedsteptime` | [`time`](./time.html) | Elapsed step time | (this) |
| `steptime` | [`time`](./time.html) | Step time | (this) |
| `totaltime` | [`time`](./time.html) | Total time | (this) |
| `canabortbuild` | [`boolean`](./boolean.html) | true if this build processor's current build is in an abortable state | (this) |
| `canbuildclass.{$class}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of building objects of this class | (this) |
| `canequipclass.{$class}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of equipping objects of this class | (this) |
| `cansupplyclass.{$class}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of supplying objects of this class | (this) |
| `canbuildequipment.{$ware}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of building this equipment | (this) |
| `canbuildequipment.{$list}` | [`boolean`](./boolean.html) | true iff this build processor's build modules is capable of building the equipment from this list | (this) |
| `canbuildmacro.{$macro}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of building this macro | (this) |
| `buildequipment.wares` | [`warelist`](./warelist.html) | All equipment wares the build processor's container can build (= default items + included items - excluded items) | (this) |
| `buildequipment.absolute` | [`warelist`](./warelist.html) | Equipment wares that have been set as the absolute list of items this build processor's container can build (see <set_equipment_wares_absolute />) | (this) |
| `buildequipment.excluded` | [`warelist`](./warelist.html) | Equipment wares that have been excluded from the default items this build processor's container can build (see <set_equipment_wares_excluded />) | (this) |
| `buildequipment.included` | [`warelist`](./warelist.html) | Equipment wares that have been included on top of the default items this build processor's container can build (see <set_equipment_wares_included />) | (this) |
| `buildequipment.<type>` | [`warelist`](./warelist.html) | Equipment wares of the specified type which the build processor's container can build (respecting included/excluded wares of that type), see buildequipment types in buildmodule | (this) |
| `buildships.wares` | [`warelist`](./warelist.html) | All ship wares the build processor's container can build, filtered by the allowed classes for this build processor's build module (= default items + included items - excluded items) | (this) |
| `buildships.absolute` | [`warelist`](./warelist.html) | Ship wares that have been set as the absolute list of items this build processor's container can build (see <set_equipment_wares_absolute />) | (this) |
| `buildships.excluded` | [`warelist`](./warelist.html) | Ship wares that have been excluded from the default items this build processor's container can build (see <set_equipment_wares_excluded />) | (this) |
| `buildships.included` | [`warelist`](./warelist.html) | Ship wares that have been included on top of the default items this build processor's container can build (see <set_equipment_wares_included />) | (this) |
| `buildmacros` | [`list`](./list.html) | List of macros the build processor's build module can build | (this) |
| `buildanchor` | [`component`](./component.html) | Build anchor | (this) |
| `constructingcomponents` | [`list`](./list.html) | List of all components under construction by this build processor | (this) |
| `constructingmodule` | [`component`](./component.html) | Module currently under construction by this build processor | (this) |
| `build` | [`build`](./build.html) | Current build task of this build processor | (this) |
| `requiresconstructionvessel` | [`boolean`](./boolean.html) | true if the current build will require a construction vessel to begin once other requirements are made | (this) |
| `mayrequireconstructionvessel` | [`boolean`](./boolean.html) | true if the current or queued build may be in need of a construction vessel (this is a tentative result and .requiresconstructionvessel may return a different result as builds progress) | (this) |
| `iswaitingforconstructionvessel` | [`boolean`](./boolean.html) | true if the current build is currently waiting for a construction vessel to start a build (usually meaning that it has enough resources/storage to start) | (this) |
| `iswaitingforresources` | [`boolean`](./boolean.html) | true if the build processor is currently waiting for resources to start a build | (this) |
| `iswaitingforstorage` | [`boolean`](./boolean.html) | true if the build processor is currently waiting for storage to start recycling | (this) |
| `currentslotresources` | [`wareamountlist`](./wareamountlist.html) | Total resources for the current build | (this) |
| `stepresources` | [`wareamountlist`](./wareamountlist.html) | Resources needed per step of the build, excluding the final step which requires .laststepresources | (this) |
| `laststepresources` | [`wareamountlist`](./wareamountlist.html) | Resources needed for the last step of the build (may differ from .stepresources due to rounding) | (this) |
| `neededslotresources` | [`wareamountlist`](./wareamountlist.html) | Resources needed for the current build | (this) |
| `neededsequenceresources` | [`wareamountlist`](./wareamountlist.html) | Resources needed for the whole sequence of builds | (this) |
| `recycled` | [`wareamountlist`](./wareamountlist.html) | Resources recycled during this sequence of builds | (this) |
