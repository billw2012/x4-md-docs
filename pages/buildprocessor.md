...
| `isbusy` | [`boolean`](./boolean.html) | true iff building |
| `isbuilding` | [`boolean`](./boolean.html) | true iff building |
| `elapsedtime` | [`time`](./time.html) | Elapsed time |
| `elapsedsteptime` | [`time`](./time.html) | Elapsed step time |
| `steptime` | [`time`](./time.html) | Step time |
| `totaltime` | [`time`](./time.html) | Total time |
| `canabortbuild` | [`boolean`](./boolean.html) | true if this build processor's current build is in an abortable state |
| `canbuildclass.{$class}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of building objects of this class |
| `canequipclass.{$class}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of equipping objects of this class |
| `cansupplyclass.{$class}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of supplying objects of this class |
| `canbuildequipment.{$ware}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of building this equipment |
| `canbuildequipment.{$list}` | [`boolean`](./boolean.html) | true iff this build processor's build modules is capable of building the equipment from this list |
| `canbuildmacro.{$macro}` | [`boolean`](./boolean.html) | true iff this build processor's build module is capable of building this macro |
| `buildequipment.wares` | [`warelist`](./warelist.html) | All equipment wares the build processor's container can build (= default items + included items - excluded items) |
| `buildequipment.absolute` | [`warelist`](./warelist.html) | Equipment wares that have been set as the absolute list of items this build processor's container can build (see <set_equipment_wares_absolute />) |
| `buildequipment.excluded` | [`warelist`](./warelist.html) | Equipment wares that have been excluded from the default items this build processor's container can build (see <set_equipment_wares_excluded />) |
| `buildequipment.included` | [`warelist`](./warelist.html) | Equipment wares that have been included on top of the default items this build processor's container can build (see <set_equipment_wares_included />) |
| `buildequipment.<type>` | [`warelist`](./warelist.html) | Equipment wares of the specified type which the build processor's container can build (respecting included/excluded wares of that type), see buildequipment types in buildmodule |
| `buildships.wares` | [`warelist`](./warelist.html) | All ship wares the build processor's container can build, filtered by the allowed classes for this build processor's build module (= default items + included items - excluded items) |
| `buildships.absolute` | [`warelist`](./warelist.html) | Ship wares that have been set as the absolute list of items this build processor's container can build (see <set_equipment_wares_absolute />) |
| `buildships.excluded` | [`warelist`](./warelist.html) | Ship wares that have been excluded from the default items this build processor's container can build (see <set_equipment_wares_excluded />) |
| `buildships.included` | [`warelist`](./warelist.html) | Ship wares that have been included on top of the default items this build processor's container can build (see <set_equipment_wares_included />) |
| `buildmacros` | [`list`](./list.html) | List of macros the build processor's build module can build |
| `buildanchor` | [`component`](./component.html) | Build anchor |
| `constructingcomponents` | [`list`](./list.html) | List of all components under construction by this build processor |
| `constructingmodule` | [`component`](./component.html) | Module currently under construction by this build processor |
| `build` | [`build`](./build.html) | Current build task of this build processor |
| `requiresconstructionvessel` | [`boolean`](./boolean.html) | true if the current build will require a construction vessel to begin once other requirements are made |
| `mayrequireconstructionvessel` | [`boolean`](./boolean.html) | true if the current or queued build may be in need of a construction vessel (this is a tentative result and .requiresconstructionvessel may return a different result as builds progress) |
| `iswaitingforconstructionvessel` | [`boolean`](./boolean.html) | true if the current build is currently waiting for a construction vessel to start a build (usually meaning that it has enough resources/storage to start) |
| `iswaitingforresources` | [`boolean`](./boolean.html) | true if the build processor is currently waiting for resources to start a build |
| `iswaitingforstorage` | [`boolean`](./boolean.html) | true if the build processor is currently waiting for storage to start recycling |
| `currentslotresources` | [`wareamountlist`](./wareamountlist.html) | Total resources for the current build |
| `stepresources` | [`wareamountlist`](./wareamountlist.html) | Resources needed per step of the build, excluding the final step which requires .laststepresources |
| `laststepresources` | [`wareamountlist`](./wareamountlist.html) | Resources needed for the last step of the build (may differ from .stepresources due to rounding) |
