...
## npcinherits from [`nonplayer`](./nonplayer.html)
...
| `npctemplate` | [`npctemplate`](./npctemplate.html) | The template for this NPC which can be used to check against the list of people on an object | (this) |
| `targetslot` | [`componentslot`](./componentslot.html) | The slot currently set as the next target for a moving NPC. The NPC may not be at this offset but in-transit to it. (component may be a room or object) | (this) |
| `currentchair` | [`componentslot`](./componentslot.html) | The chair slot the NPC is currently inhabiting. Not set when moving towards the chair. (component may be a room or object) | (this) |
| `hasclothingmod` | [`boolean`](./boolean.html) | Whether the NPC has any clothing mod installed | (this) |
| `hasclothingmod.{$ware}` | [`boolean`](./boolean.html) | Whether the NPC has a clothing mod based on the specified clothing mod ware installed | (this) |
| `hastool` | [`boolean`](./boolean.html) | Whether the NPC currently carries a tool | (this) |
| `isinconversation` | [`boolean`](./boolean.html) | Is the NPC currently involved in a player conversation? | (this) |
