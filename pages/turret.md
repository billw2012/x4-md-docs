...
| `ammo.capacity` | [`integer`](./integer.html) | Amount of ammostorage this weapon adds to its destructible | [`weapon`](./weapon.html) |
| `ammo.macro` | [`macro`](./macro.html) | Macro of the used ammo | [`weapon`](./weapon.html) |
| `ammo.ware` | [`ware`](./ware.html) | Ware that can provide the used ammomacro | [`weapon`](./weapon.html) |
| `ammo.iscompatible.{$macro}` | [`boolean`](./boolean.html) | true iff the supplied ammo macro (missile) is compatible with this weapon | [`weapon`](./weapon.html) |
| `isreadytofire` | [`boolean`](./boolean.html) | Is ready to fire (weapon active, turret deployed) | [`weapon`](./weapon.html) |
| `mode` | [`weaponmode`](./weaponmode.html) | mode this weapon/turret is operating in | [`weapon`](./weapon.html) |
| `isrepairing` | [`boolean`](./boolean.html) | Whether the weapon is for repairing | [`weapon`](./weapon.html) |
| `ismining` | [`boolean`](./boolean.html) | Whether the weapon is for mining | [`weapon`](./weapon.html) |
| `iscombat` | [`boolean`](./boolean.html) | Whether the weapon is neither for repairing nor for mining | [`weapon`](./weapon.html) |
| `barrelposition` | [`position`](./position.html) | The position of the weapon's barrel (may be 0,0,0 for weapons with no collision) | [`weapon`](./weapon.html) |
