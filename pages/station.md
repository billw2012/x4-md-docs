...
| `buildplot.max` | [`vector`](./vector.html) | Maximum bounds of station's build plot |
| `buildplot.center` | [`vector`](./vector.html) | Center position of station's build plot |
| `buildplot.price` | [`money`](./money.html) | The licence price for this build plot at the station's location |
| `paidbuildplot.exists` | [`boolean`](./boolean.html) | Whether station's build plot licenced by the player has non-zero dimensions |
| `paidbuildplot.max` | [`vector`](./vector.html) | Maximum bounds of station's build plot licenced by the player |
| `paidbuildplot.center` | [`vector`](./vector.html) | Center position of station's build plot licenced by the player |
| `paidbuildplot.payment` | [`money`](./money.html) | Amount the player paid for the current build plot licence |
| `paidbuildplot.haspositionchanged` | [`boolean`](./boolean.html) | Whether the station's position has changed since the build plot was licenced |
| `buildstorage` | [`buildstorage`](./buildstorage.html) | Build storage of the station |
| `istradestation` | [`boolean`](./boolean.html) | True if this station is a trade station |
| `isshipyard` | [`boolean`](./boolean.html) | True if this station is a shipyard, i.e. it can build capital ships (see also .canbuildships) |
| `iswharf` | [`boolean`](./boolean.html) | True if this station is a wharf, i.e. it can build non-capital ships (see also .canbuildships) |
| `isequipmentdock` | [`boolean`](./boolean.html) | True if this station is an equipment dock, i.e. it can change loadouts (see also .canequipships) but cannot build ships from scratch |
| `isdefencestation` | [`boolean`](./boolean.html) | True if this station is a defence station |
| `isrecyclingfacility` | [`boolean`](./boolean.html) | True if this station is a recycling facility with a processing module |
| `ispiratebase` | [`boolean`](./boolean.html) | True if this station is a pirate base |
| `isheadquarters` | [`boolean`](./boolean.html) | True if this station macro is tagged as a headquarters. Normally only true for the Player HQ. |
| `isfactionheadquarters` | [`boolean`](./boolean.html) | True if this station is a faction headquarters |
| `isplannedshipyard` | [`boolean`](./boolean.html) | True if this station is set to be a shipyard when fully constructed, i.e. it can build capital ships (see also .canbuildships) |
| `isplannedwharf` | [`boolean`](./boolean.html) | True if this station is set to be a wharf when fully constructed, i.e. it can build non-capital ships (see also .canbuildships) |
