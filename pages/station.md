...
| `buildplot.exists` | [`boolean`](./boolean.html) | Whether station's build plot has non-zero dimensions | (this) |
| `buildplot.max` | [`vector`](./vector.html) | Maximum bounds of station's build plot | (this) |
| `buildplot.center` | [`vector`](./vector.html) | Center position of station's build plot | (this) |
| `buildplot.price` | [`money`](./money.html) | The licence price for this build plot at the station's location | (this) |
| `paidbuildplot.exists` | [`boolean`](./boolean.html) | Whether station's build plot licenced by the player has non-zero dimensions | (this) |
| `paidbuildplot.max` | [`vector`](./vector.html) | Maximum bounds of station's build plot licenced by the player | (this) |
| `paidbuildplot.center` | [`vector`](./vector.html) | Center position of station's build plot licenced by the player | (this) |
| `paidbuildplot.payment` | [`money`](./money.html) | Amount the player paid for the current build plot licence | (this) |
| `paidbuildplot.haspositionchanged` | [`boolean`](./boolean.html) | Whether the station's position has changed since the build plot was licenced | (this) |
| `buildstorage` | [`buildstorage`](./buildstorage.html) | Build storage of the station | (this) |
| `istradestation` | [`boolean`](./boolean.html) | True if this station is a trade station | (this) |
| `isshipyard` | [`boolean`](./boolean.html) | True if this station is a shipyard, i.e. it can build capital ships (see also .canbuildships) | (this) |
| `iswharf` | [`boolean`](./boolean.html) | True if this station is a wharf, i.e. it can build non-capital ships (see also .canbuildships) | (this) |
| `isequipmentdock` | [`boolean`](./boolean.html) | True if this station is an equipment dock, i.e. it can change loadouts (see also .canequipships) but cannot build ships from scratch | (this) |
| `isdefencestation` | [`boolean`](./boolean.html) | True if this station is a defence station | (this) |
| `isrecyclingfacility` | [`boolean`](./boolean.html) | True if this station is a recycling facility with a processing module | (this) |
| `ispiratebase` | [`boolean`](./boolean.html) | True if this station is a pirate base | (this) |
| `isheadquarters` | [`boolean`](./boolean.html) | True if this station macro is tagged as a headquarters. Normally only true for the Player HQ. | (this) |
| `isfactionheadquarters` | [`boolean`](./boolean.html) | True if this station is a faction headquarters | (this) |
| `isplannedshipyard` | [`boolean`](./boolean.html) | True if this station is set to be a shipyard when fully constructed, i.e. it can build capital ships (see also .canbuildships) | (this) |
| `isplannedwharf` | [`boolean`](./boolean.html) | True if this station is set to be a wharf when fully constructed, i.e. it can build non-capital ships (see also .canbuildships) | (this) |
| `isplannedequipmentdock` | [`boolean`](./boolean.html) | True if this station is set to be an equipment dock, when fully constructed, i.e. it can change loadouts (see also .canequipships) but cannot build ships from scratch | (this) |
| `isplanneddefencestation` | [`boolean`](./boolean.html) | True if this station is set to be a defence station, when fully constructed | (this) |
| `isplannedrecyclingfacility` | [`boolean`](./boolean.html) | True if this station is set to be a recycling facility with a processing module, when fully constructed | (this) |
