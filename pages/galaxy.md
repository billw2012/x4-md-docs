...
| `yieldthresholds` | [`wareamountlist`](./wareamountlist.html) | Amounts of mineable wares that meet valuethreshold set in parameters.xml | (this) |
| `representatives` | [`list`](./list.html) | List of all faction representatives in the galaxy | (this) |
