...
| `adjacentzones` | [`list`](./list.html) | List of adjacent zones | [`zone`](./zone.html) |
| `haspriority` | [`boolean`](./boolean.html) | true iff zone has highest priority in its area. false for highways | [`zone`](./zone.html) |
| `policefaction` | [`faction`](./faction.html) | Police faction for this zone, which is the police faction of the zone owner (may be null) | [`zone`](./zone.html) |
| `istempzone` | [`boolean`](./boolean.html) | true iff temporary zone | [`zone`](./zone.html) |
| `isnormalzone` | [`boolean`](./boolean.html) | true iff normal zone (not temporary, not gate zone and not highway) | [`zone`](./zone.html) |
| `size` | [`length`](./length.html) | Zone size (edge length) | [`zone`](./zone.html) |
| `hashazardousregionat.{$position}` | [`boolean`](./boolean.html) | Whether the given zone position is inside a hazardous region | [`zone`](./zone.html) |
| `isregioncurrentlyhazardousat.{$position}` | [`boolean`](./boolean.html) | Whether the given zone position is inside a region that is currently hazardous | [`zone`](./zone.html) |
| `islocalhighway` | [`boolean`](./boolean.html) | true iff local highway | (this) |
| `issuperhighway` | [`boolean`](./boolean.html) | true iff super highway | (this) |
| `origin` | [`zone`](./zone.html) | Highway origin zone | (this) |
| `destination` | [`zone`](./zone.html) | Highway destination zone | (this) |
| `junctions` | [`list`](./list.html) | List of zones along a highway | (this) |
| `entry` | [`highwayentrygate`](./highwayentrygate.html) | Highway entry gate | (this) |
| `exit` | [`highwayexitgate`](./highwayexitgate.html) | Highway exit gate | (this) |
| `entryjumpgate` | [`gate`](./gate.html) | Jumpgate which leads into this highway | (this) |
| `exitjumpgate` | [`gate`](./gate.html) | Jumpgate which this highway leads into | (this) |
| `closestpointtoplayer` | [`position`](./position.html) | Closest highway point to player in highway coordinates (x=y=0, z-coord range 0-1) | (this) |
