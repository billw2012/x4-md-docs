...
|------|------|-------------|
| `islocalhighway` | [`boolean`](./boolean.html) | true iff local highway |
| `issuperhighway` | [`boolean`](./boolean.html) | true iff super highway |
| `origin` | [`zone`](./zone.html) | Highway origin zone |
| `destination` | [`zone`](./zone.html) | Highway destination zone |
| `junctions` | [`list`](./list.html) | List of zones along a highway |
| `entry` | [`highwayentrygate`](./highwayentrygate.html) | Highway entry gate |
| `exit` | [`highwayexitgate`](./highwayexitgate.html) | Highway exit gate |
| `entryjumpgate` | [`gate`](./gate.html) | Jumpgate which leads into this highway |
| `exitjumpgate` | [`gate`](./gate.html) | Jumpgate which this highway leads into |
| `closestpointtoplayer` | [`position`](./position.html) | Closest highway point to player in highway coordinates (x=y=0, z-coord range 0-1) |
## Properties inherited from [`zone`](./zone.html)
| Name | Type | Description |
|------|------|-------------|
| `adjacentzones` | [`list`](./list.html) | List of adjacent zones |
| `haspriority` | [`boolean`](./boolean.html) | true iff zone has highest priority in its area. false for highways |
| `policefaction` | [`faction`](./faction.html) | Police faction for this zone, which is the police faction of the zone owner (may be null) |
| `istempzone` | [`boolean`](./boolean.html) | true iff temporary zone |
| `isnormalzone` | [`boolean`](./boolean.html) | true iff normal zone (not temporary, not gate zone and not highway) |
