...
| `destination` | [`zone`](./zone.html) | Destination zone | (this) |
| `exit` | [`gate`](./gate.html) | Destination gate | (this) |
| `isaccelerator` | [`boolean`](./boolean.html) | Is gate a trans-orbital accelerator | (this) |
| `entryhighway` | [`highway`](./highway.html) | Highway which leads into this gate | (this) |
| `exithighway` | [`highway`](./highway.html) | Highway which this gate leads into | (this) |
| `waitingship` | [`ship`](./ship.html) | Ship that has currently reserved the gate | (this) |
