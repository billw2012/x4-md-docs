...
| `type` | [`roomtype`](./roomtype.html) | Room type | (this) |
| `islocked` | [`boolean`](./boolean.html) | Is the room locked | (this) |
| `isgrouplocked.{$grouptag}` | [`boolean`](./boolean.html) | Is the specified grouptag in this room locked | (this) |
| `isprivate` | [`boolean`](./boolean.html) | Is the room in a dynamic interior which is set to be private. If true, contained NPC slots can only be found by directly querying the room | (this) |
| `iswalkable` | [`boolean`](./boolean.html) | Is the room walkable, i.e. accessible to the player and NPCs? This can be false e.g. for docking bays in space or in internal storage | (this) |
| `dockarea` | [`dockarea`](./dockarea.html) | The dock area this room is a part of | (this) |
| `buildmodule` | [`buildmodule`](./buildmodule.html) | The build module this room is a part of | (this) |
| `walkablemodule` | [`walkablemodule`](./walkablemodule.html) | The walkable module (dock area or build module) this room is a part of | (this) |
| `dynamicinterior` | [`navcontext`](./navcontext.html) | The dynamic interior this room is a part of | (this) |
| `actors` | [`list`](./list.html) | List of actors in the room | (this) |
...
| `numfreeactorslots` | [`integer`](./integer.html) | Number of free actor slots in the room | (this) |
| `freemissionactorslot` | [`boolean`](./boolean.html) | true iff there is a free mission actor slot in the room | (this) |
| `slotcontext` | [`component`](./component.html) | The component which contains entity slots related to this room. For virtual rooms, it will be the controllable otherwise the room itself | (this) |
| `ischairslot.{$componentslot}` | [`boolean`](./boolean.html) | True if $componentslot is a NPC position slot within this room and related to a chair | (this) |
| `chairapproachslot.{$componentslot}` | [`componentslot`](./componentslot.html) | The approach slot of a NPC position slot related to a chair in this room | (this) |
| `chairbaseslot.{$componentslot}` | [`componentslot`](./componentslot.html) | The base chair slot of a NPC position slot related to a chair in this room. Used as a static anchor slot for the chair and can be used as a NPC waypoint. | (this) |
| `chairroomslot.{$componentslot}` | [`componentslot`](./componentslot.html) | The room slot related to a chair in this room, to be used by NPCs for destination reservation. | (this) |
| `controlposition.{$controlposition}.exists` | [`boolean`](./boolean.html) | True if the specified control position exists | (this) |
| `controlposition.{$controlposition}.roomslot` | [`componentslot`](./componentslot.html) | Slot which entities inhabit when working at the specified control position | (this) |
| `controlposition.{$controlposition}.entity` | [`entity`](./entity.html) | Entity currently working at the specified control position | (this) |
| `controlpositions.list` | [`list`](./list.html) | List of component slots which are control positions | (this) |
| `hascontrolpanel.{$controlpaneltype}` | [`boolean`](./boolean.html) | True if this room has a control panel of the specified type | (this) |
