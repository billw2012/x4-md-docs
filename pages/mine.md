...
|------|------|-------------|
| `isfriendfoe` | [`boolean`](./boolean.html) | Whether the mine has a friend/foe feature |
| `friendlist` | [`list`](./list.html) | Friend list for mine (only for mines friend/foe feature) |
| `foelist` | [`list`](./list.html) | Foe list for mine (only for mines friend/foe feature) |
| `target` | [`destructible`](./destructible.html) | Mine target |
