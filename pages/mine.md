...
| `isfriendfoe` | [`boolean`](./boolean.html) | Whether the mine has a friend/foe feature | (this) |
| `friendlist` | [`list`](./list.html) | Friend list for mine (only for mines friend/foe feature) | (this) |
| `foelist` | [`list`](./list.html) | Foe list for mine (only for mines friend/foe feature) | (this) |
| `target` | [`destructible`](./destructible.html) | Mine target | (this) |
