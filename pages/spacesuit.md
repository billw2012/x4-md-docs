...
| `type` | [`shiptype`](./shiptype.html) | Ship type | [`ship`](./ship.html) |
| `typename` | [`string`](./string.html) | Ship type name | [`ship`](./ship.html) |
| `numfreeactorslots` | [`integer`](./integer.html) | Number of free actor slots | [`ship`](./ship.html) |
| `actors` | [`list`](./list.html) | List of actors on the ship | [`ship`](./ship.html) |
| `assigneddock` | [`dockingbay`](./dockingbay.html) | Dock currently assigned to this ship | [`ship`](./ship.html) |
| `assignedventuredock` | [`dockingbay`](./dockingbay.html) | Venture dock currently assigned to this ship | [`ship`](./ship.html) |
| `docksize` | [`tag`](./tag.html) | Tag of required dock size | [`ship`](./ship.html) |
| `dock` | [`dockingbay`](./dockingbay.html) | Dock where this ship is docked | [`ship`](./ship.html) |
| `dockslot` | [`componentslot`](./componentslot.html) | Slot on the ship to which docking bay connects when ship is docked | [`ship`](./ship.html) |
| `todockposition.{$dockingbay}` | [`position`](./position.html) | The positional offset to the forward facing todock position relative to the ship's current position | [`ship`](./ship.html) |
| `todockrotation.{$dockingbay}` | [`rotation`](./rotation.html) | The rotational offset to the forward facing todock position relative to the ship's current orientation | [`ship`](./ship.html) |
| `todockpositionreverse.{$dockingbay}` | [`position`](./position.html) | The positional offset to the backwards facing todock position relative to the ship's current position | [`ship`](./ship.html) |
| `todockrotationreverse.{$dockingbay}` | [`rotation`](./rotation.html) | The rotational offset to the backwards facing todock position relative to the ship's current orientation | [`ship`](./ship.html) |
| `hidecargochance` | [`float`](./float.html) | Chance that illegal or valuable cargo on board is successfully hidden from scans (0-100, higher is better) | [`ship`](./ship.html) |
| `maxspeed` | [`length`](./length.html) | Maximum speed with present engine set up and conditions (in m/s) | [`ship`](./ship.html) |
| `maxyawspeed` | [`angle`](./angle.html) | Maximum rate of change in yaw with present engine set up and conditions (in rad/s) | [`ship`](./ship.html) |
| `maxpitchspeed` | [`angle`](./angle.html) | Maximum rate of change in pitch with present engine set up and conditions (in rad/s) | [`ship`](./ship.html) |
| `maxrollspeed` | [`angle`](./angle.html) | Maximum rate of change in roll with present engine set up and conditions (in rad/s) | [`ship`](./ship.html) |
| `speedlimit` | [`length`](./length.html) | The speed limit currently imposed by the ship's environment (in m/s, -1 if there is none) | [`ship`](./ship.html) |
| `canenterhighway` | [`boolean`](./boolean.html) | True iff this ship is capable of entering highways | [`ship`](./ship.html) |
| `parkedat` | [`destructible`](./destructible.html) | Tradeoffer component that this ship is parked at (= has parking connection to) | [`ship`](./ship.html) |
| `pickedupobject` | [`object`](./object.html) | The object which is currently being carried by this ship | [`ship`](./ship.html) |
| `regiondamageprotection` | [`float`](./float.html) | Amount of protection against static environmental damage (0-100, higher is better) | [`ship`](./ship.html) |
| `job` | [`string`](./string.html) | job ID | [`ship`](./ship.html) |
| `jobname` | [`string`](./string.html) | job name | [`ship`](./ship.html) |
| `isjobship` | [`boolean`](./boolean.html) | true if this is a job ship | [`ship`](./ship.html) |
| `isrequestedjobship` | [`boolean`](./boolean.html) | true if this is a requested job ship | [`ship`](./ship.html) |
| `jobexpired` | [`boolean`](./boolean.html) | true if this is a non-commandeered job ship which has passed its expiration time | [`ship`](./ship.html) |
| `jobcommander` | [`ship`](./ship.html) | the original ship which this ship was set to call commander (may have changed) | [`ship`](./ship.html) |
| `jobmainsector` | [`sector`](./sector.html) | the sector this ship is set to perform in or start from | [`ship`](./ship.html) |
| `jobmainzone` | [`zone`](./zone.html) | the zone this ship is set to perform in or start from | [`ship`](./ship.html) |
| `isvalidjobspace.{$space}` | [`boolean`](./boolean.html) | is the provided space currently valid according to the job definition of this ship | [`ship`](./ship.html) |
| `jobsubordinates.valid` | [`list`](./list.html) | List of subordinates who's place in the hierarchy is valid according to the job definition of this ship | [`ship`](./ship.html) |
| `jobsubordinates.invalid` | [`list`](./list.html) | List of subordinates who's place in the hierarchy is not valid according to the job definition of this ship | [`ship`](./ship.html) |
| `encounterid` | [`string`](./string.html) | Encounter type ID defined by this ship's job | [`ship`](./ship.html) |
| `isencountership` | [`boolean`](./boolean.html) | true if this is a ship for encounters | [`ship`](./ship.html) |
| `warebasket` | [`warelist`](./warelist.html) | Wares in job ship basket | [`ship`](./ship.html) |
| `constructionmodule` | [`buildmodule`](./buildmodule.html) | Build module which this construction vessel is assigned to be deployed at | [`ship`](./ship.html) |
| `isdeployedconstructionvessel` | [`boolean`](./boolean.html) | true if this ship is a construction vessel currently deployed at their 'constructionmodule' | [`ship`](./ship.html) |
| `iscapitalship` | [`boolean`](./boolean.html) | true if this is a capital ship (size L or XL) | [`ship`](./ship.html) |
| `islasertower` | [`boolean`](./boolean.html) | true iff the ship is a lasertower | [`ship`](./ship.html) |
| `hasshipmod` | [`boolean`](./boolean.html) | Whether the object has any ship mod installed | [`ship`](./ship.html) |
| `hasshipmod.{$ware}` | [`boolean`](./boolean.html) | Whether the object has a ship mod based on the specified ship mod ware installed | [`ship`](./ship.html) |
| `canbeclaimed` | [`boolean`](./boolean.html) | Whether the ship is currently in a claimable state | [`ship`](./ship.html) |
| `defaultformationradius.{$ship}` | [`length`](./length.html) | The appropriate formation radius for this ship and its formation leader($ship) | [`ship`](./ship.html) |
| `issupplyship` | [`boolean`](./boolean.html) | True if this ship is capable of re-supplying other ships, i.e. it can repair ships and equipment or produce ammo/units (see also .cansupplyships) but cannot build equipment or ships from scratch | [`ship`](./ship.html) |
| `movementrefobject` | [`object`](./object.html) | The object this ship is currently moving relative to | [`ship`](./ship.html) |
| `activeweapongroup.primary` | [`integer`](./integer.html) | The currently active primary weapon group | [`ship`](./ship.html) |
| `activeweapongroup.secondary` | [`integer`](./integer.html) | The currently active secondary weapon group | [`ship`](./ship.html) |
| `environment` | [`component`](./component.html) | Component which this ship is currently physically inside, but not necessarily connected to (limited to specific components, usually dock areas and build modules) | [`ship`](./ship.html) |
| `cantowobjects` | [`boolean`](./boolean.html) | true iff this ship is capable of towing objects | [`ship`](./ship.html) |
| `towedobject` | [`object`](./object.html) | the object this ship is towing | [`ship`](./ship.html) |
| `takesregiondamage` | [`boolean`](./boolean.html) | true if this ship is susceptible to region damage | [`ship`](./ship.html) |
| `oxygenempty` | [`boolean`](./boolean.html) | Is the spacesuit empty of oxygen | (this) |
| `oxygenlow` | [`boolean`](./boolean.html) | Is the spacesuit low on oxygen | (this) |
| `oxygenpercentage` | [`float`](./float.html) | Percentage of remaining oxygen supply | (this) |
| `oxygentimeremaining` | [`time`](./time.html) | Remaining time until oxygen is depleted | (this) |
