...
|------|------|-------------|
| `isnormalcluster` | [`boolean`](./boolean.html) | true iff normal cluster (not presentation cluster, not venturer cluster) |
| `ispresentation` | [`boolean`](./boolean.html) | true iff cluster is used for presentation scenes e.g. cutscenes |
| `systemid` | [`integer`](./integer.html) | the system ID of the cluster, used to identify which star system the cluster belongs to. This property is 0 if the cluster is the only cluster in the system |
| `gravidarfactorat.{$position}` | [`float`](./float.html) | Gravidar factor at the given cluster position |
| `hashazardousregionat.{$position}` | [`boolean`](./boolean.html) | Whether the given cluster position is inside a hazardous region |
| `isregioncurrentlyhazardousat.{$position}` | [`boolean`](./boolean.html) | Whether the given cluster position is inside a region that is currently hazardous |
| `planets` | [`list`](./list.html) | List of part names related to planets (data defined in mapdefaults.xml) |
| `moons.{$string}` | [`list`](./list.html) | List of part names related to moons of the specified planet (data defined in mapdefaults.xml) |
| `world.{$string}.position.{$component}` | [`list`](./list.html) | Position of the world of specified part name, relative to $component |
| `terraforming.partname` | [`string`](./string.html) | The template part name of the planet that can be terraformed |
| `terraforming.planetposition.{$component}` | [`position`](./position.html) | The position of the planet that can be terraformed, relative to $component |
| `terraforming.stat.{$statid}.exists` | [`boolean`](./boolean.html) | true iff the terraforming stat is either dynamic or has been set manually |
| `terraforming.stat.{$statid}.value` | [`largeint`](./largeint.html) | The raw value of the terraforming stat |
| `terraforming.stat.{$statid}.state` | [`integer`](./integer.html) | The state number of the terraforming stat (corresponds to a color in the UI) |
| `terraforming.project.{$projectid}.exists` | [`boolean`](./boolean.html) | Whether the terraforming project exists on this planet |
| `terraforming.project.{$projectid}.name` | [`string`](./string.html) | The name of the terraforming project |
| `terraforming.project.{$projectid}.description` | [`string`](./string.html) | The description of the terraforming project |
| `terraforming.project.{$projectid}.complete` | [`boolean`](./boolean.html) | Whether the terraforming project has been completed at least once |
| `terraforming.project.{$projectid}.successchance` | [`integer`](./integer.html) | The terraforming project's chance of success upon completion |
| `terraforming.project.{$projectid}.resources` | [`wareamountlist`](./wareamountlist.html) | Total Required scaled-resources for this project to complete |
| `terraforming.mission.active` | [`boolean`](./boolean.html) | Whether the terraforming mission for this cluster has been accepted |
| `terraforming.mission.complete` | [`boolean`](./boolean.html) | Whether the terraforming mission for this cluster has been completed |
## Properties inherited from [`space`](./space.html)
| Name | Type | Description |
|------|------|-------------|
| `economy` | [`float`](./float.html) | Economy value for this space |
| `security` | [`float`](./float.html) | Security value for this space |
| `sunlight` | [`largefloat`](./largefloat.html) | Sunlight value for this space |
| `god` | [`boolean`](./boolean.html) | God entries allowed for this space |
| `jobs` | [`boolean`](./boolean.html) | Job entries allowed for this space |
| `isexclusiveforextensionjobs` | [`boolean`](./boolean.html) | Is the space exclusive for job definitions of its own extension, affecting potential spawn location and jobmainsector/zone selection. Inherits exclusivity from parent spaces. |
| `factionlogic` | [`boolean`](./boolean.html) | Faction logic allowed for this space |
| `locationtags` | [`list`](./list.html) | List of tags relevant to this space location |
