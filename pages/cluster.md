...
| `economy` | [`float`](./float.html) | Economy value for this space | [`space`](./space.html) |
| `security` | [`float`](./float.html) | Security value for this space | [`space`](./space.html) |
| `sunlight` | [`largefloat`](./largefloat.html) | Sunlight value for this space | [`space`](./space.html) |
| `god` | [`boolean`](./boolean.html) | God entries allowed for this space | [`space`](./space.html) |
| `jobs` | [`boolean`](./boolean.html) | Job entries allowed for this space | [`space`](./space.html) |
| `isexclusiveforextensionjobs` | [`boolean`](./boolean.html) | Is the space exclusive for job definitions of its own extension, affecting potential spawn location and jobmainsector/zone selection. Inherits exclusivity from parent spaces. | [`space`](./space.html) |
| `factionlogic` | [`boolean`](./boolean.html) | Faction logic allowed for this space | [`space`](./space.html) |
| `locationtags` | [`list`](./list.html) | List of tags relevant to this space location | [`space`](./space.html) |
| `alllocationtags` | [`list`](./list.html) | List of tags relevant to this space location and all parent spaces | [`space`](./space.html) |
| `accesslicence` | [`string`](./string.html) | Licence type required for access to this space (null if no restriction) | [`space`](./space.html) |
| `accessrestricted` | [`boolean`](./boolean.html) | Access to this space restricted (for player assets) | [`space`](./space.html) |
| `isnormalcluster` | [`boolean`](./boolean.html) | true iff normal cluster (not presentation cluster, not venturer cluster) | (this) |
| `ispresentation` | [`boolean`](./boolean.html) | true iff cluster is used for presentation scenes e.g. cutscenes | (this) |
| `systemid` | [`integer`](./integer.html) | the system ID of the cluster, used to identify which star system the cluster belongs to. This property is 0 if the cluster is the only cluster in the system | (this) |
| `gravidarfactorat.{$position}` | [`float`](./float.html) | Gravidar factor at the given cluster position | (this) |
| `hashazardousregionat.{$position}` | [`boolean`](./boolean.html) | Whether the given cluster position is inside a hazardous region | (this) |
| `isregioncurrentlyhazardousat.{$position}` | [`boolean`](./boolean.html) | Whether the given cluster position is inside a region that is currently hazardous | (this) |
| `planets` | [`list`](./list.html) | List of part names related to planets (data defined in mapdefaults.xml) | (this) |
| `moons.{$string}` | [`list`](./list.html) | List of part names related to moons of the specified planet (data defined in mapdefaults.xml) | (this) |
| `world.{$string}.position.{$component}` | [`list`](./list.html) | Position of the world of specified part name, relative to $component | (this) |
| `terraforming.partname` | [`string`](./string.html) | The template part name of the planet that can be terraformed | (this) |
| `terraforming.planetposition.{$component}` | [`position`](./position.html) | The position of the planet that can be terraformed, relative to $component | (this) |
| `terraforming.stat.{$statid}.exists` | [`boolean`](./boolean.html) | true iff the terraforming stat is either dynamic or has been set manually | (this) |
| `terraforming.stat.{$statid}.value` | [`largeint`](./largeint.html) | The raw value of the terraforming stat | (this) |
| `terraforming.stat.{$statid}.state` | [`integer`](./integer.html) | The state number of the terraforming stat (corresponds to a color in the UI) | (this) |
| `terraforming.project.{$projectid}.exists` | [`boolean`](./boolean.html) | Whether the terraforming project exists on this planet | (this) |
| `terraforming.project.{$projectid}.name` | [`string`](./string.html) | The name of the terraforming project | (this) |
| `terraforming.project.{$projectid}.description` | [`string`](./string.html) | The description of the terraforming project | (this) |
| `terraforming.project.{$projectid}.complete` | [`boolean`](./boolean.html) | Whether the terraforming project has been completed at least once | (this) |
| `terraforming.project.{$projectid}.successchance` | [`integer`](./integer.html) | The terraforming project's chance of success upon completion | (this) |
| `terraforming.project.{$projectid}.resources` | [`wareamountlist`](./wareamountlist.html) | Total Required scaled-resources for this project to complete | (this) |
| `terraforming.mission.active` | [`boolean`](./boolean.html) | Whether the terraforming mission for this cluster has been accepted | (this) |
| `terraforming.mission.complete` | [`boolean`](./boolean.html) | Whether the terraforming mission for this cluster has been completed | (this) |
