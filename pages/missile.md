...
| `isguided` | [`boolean`](./boolean.html) | true if this explosive is guided | [`explosive`](./explosive.html) |
| `countermeasureresistance.{$macro}` | [`float`](./float.html) | percentage change of this explosive resisting the effects of the provided countermeasure macro | [`explosive`](./explosive.html) |
| `target` | [`destructible`](./destructible.html) | Missile target | (this) |
| `launcher` | [`destructible`](./destructible.html) | Object that launched this missile | (this) |
