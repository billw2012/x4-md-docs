...
| `boost.available` | [`boolean`](./boolean.html) | true iff the booster can be activated right now | (this) |
| `boost.active` | [`boolean`](./boolean.html) | true iff the booster is currently active | (this) |
| `boost.chargetime` | [`time`](./time.html) | Charge time until the boost starts | (this) |
| `boost.rechargetime` | [`time`](./time.html) | Time required to recharge after a boost | (this) |
| `boost.maxduration` | [`time`](./time.html) | The maximum boost duration possible | (this) |
| `boost.maxspeed` | [`length`](./length.html) | Maximum boost speed with present engine set up and conditions (in m/s) | (this) |
| `travel.available` | [`boolean`](./boolean.html) | true iff the engine's travel mode can be activated right now | (this) |
| `travel.active` | [`boolean`](./boolean.html) | true iff the engine is currently traveling | (this) |
...
| `travel.iscoasting` | [`boolean`](./boolean.html) | true iff the engine is currently coasting after turning off travel mode | (this) |
