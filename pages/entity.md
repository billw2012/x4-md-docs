...
| `customhandler` | [`boolean`](./boolean.html) | true iff the entity has a custom conversation handler | (this) |
| `type` | [`entitytype`](./entitytype.html) | Entity type | (this) |
| `typename` | [`string`](./string.html) | Entity type name | (this) |
| `controlpost` | [`controlpost`](./controlpost.html) | Entity's current control post | (this) |
| `role` | [`entityrole`](./entityrole.html) | Entity's current role | (this) |
| `roleobject` | [`controllable`](./controllable.html) | Object this entity is assigned to for their role | (this) |
| `titleoverride` | [`string`](./string.html) | Entity's title override | (this) |
| `iconoverride` | [`string`](./string.html) | Entity's icon override | (this) |
| `occupationname` | [`string`](./string.html) | Entity's occupation name | (this) |
| `icon` | [`string`](./string.html) | Entity's icon ID | (this) |
| `race` | [`race`](./race.html) | The entity's race | (this) |
| `page` | [`integer`](./integer.html) | Voice text page ID | (this) |
| `isfemale` | [`boolean`](./boolean.html) | Is entity female | (this) |
| `isavatar` | [`boolean`](./boolean.html) | Is entity an avatar of another | (this) |
| `iscommable` | [`boolean`](./boolean.html) | Can communication be initiated with this entity | (this) |
| `ismissionactor` | [`boolean`](./boolean.html) | Is a mission actor | (this) |
| `isremotecommable` | [`boolean`](./boolean.html) | Is remote commable | (this) |
| `iscontrolentity` | [`boolean`](./boolean.html) | Is a control entity | (this) |
...
| `ishidden` | [`boolean`](./boolean.html) | Is the entity hidden? | (this) |
...
| `roomslot` | [`componentslot`](./componentslot.html) | The slot assigned for this entity. The entity may not be at this offset but in-transit to it. (component may be a room or object) | (this) |
| `floortags` | [`list`](./list.html) | A list of floor tags of the entities current floor | (this) |
| `iswalking` | [`boolean`](./boolean.html) | Is the NPC currently walking | (this) |
| `slowwalkspeed` | [`float`](./float.html) | Defined slow walk speed of this entity | (this) |
| `walkspeed` | [`float`](./float.html) | Defined walk speed of this entity | (this) |
| `runspeed` | [`float`](./float.html) | Defined run speed of this entity | (this) |
| `isspeaking` | [`boolean`](./boolean.html) | Is the entity currently speaking? | (this) |
| `isinspeakrange` | [`boolean`](./boolean.html) | Is the entity close enough to the player to speak directly without using comms? | (this) |
| `isinspeakrange.{$entity}` | [`boolean`](./boolean.html) | Is the entity close enough to the supplied recipient entity to speak directly without using comms? | (this) |
| `lastspeaktime` | [`time`](./time.html) | Time of when the entity was last speaking, or null if entity has never spoken (at least not since lastspeaktime support was added in X4 v6.00) | (this) |
| `experienceprogress` | [`integer`](./integer.html) | Boarding experience progress | (this) |
| `neededexperience` | [`integer`](./integer.html) | Needed boarding experience for next level | (this) |
...
| `combinedskill` | [`integer`](./integer.html) | Combined skill value between 0 and 100, based on weighted skills that are relevant for the entity's control post | (this) |
...
| `controlled` | [`controllable`](./controllable.html) | Object controlled by the entity | (this) |
| `assignedcontrolled` | [`controllable`](./controllable.html) | Object assigned to be controlled by the entity | (this) |
| `dockarea` | [`dockarea`](./dockarea.html) | The dock area this entity is currently on | (this) |
| `buildmodule` | [`buildmodule`](./buildmodule.html) | The build module this entity is currently on | (this) |
| `walkablemodule` | [`walkablemodule`](./walkablemodule.html) | The walkable module (dock area or build module) this entity is currently on | (this) |
| `inventory` | [`wareamountlist`](./wareamountlist.html) | Wares currently in entity's inventory | (this) |
| `stock` | [`warelist`](./warelist.html) | Wares in entity's stock list | (this) |
| `cancraft.{$ware}` | [`boolean`](./boolean.html) | Can craft inventory ware | (this) |
| `command.value` | [`command`](./command.html) | Script command that the entity is executing | (this) |
...
| `commandaction.value` | [`commandaction`](./commandaction.html) | Script command action that the entity is executing | (this) |
...
| `shouldinformplayer` | [`boolean`](./boolean.html) | true iff entity is on a player-owned ship that either has the player.occupiedship or a ship without a pilot as commander and that has no looped orders | (this) |
| `shouldwarnplayer` | [`boolean`](./boolean.html) | true iff entity is on a player-owned ship that either has the player.occupiedship or a ship without a pilot as commander or has no commander at all and that has no looped orders | (this) |
| `istradecomputer` | [`boolean`](./boolean.html) | Is this entity assigned as a trade computer to process trade operations on the player-controlled ship? | (this) |
| `isshadyguy` | [`boolean`](./boolean.html) | Is this entity assigned as a black marketeer to handle extralegal business? | (this) |
| `isindependent` | [`boolean`](./boolean.html) | whether ownership of this entity is independent of ownership of object to which they are assigned (always true if entity has no control post or role) | (this) |
| `tradesvisible` | [`boolean`](./boolean.html) | true iff the entity's trades are visible to the player | (this) |
| `facecutscene` | [`string`](./string.html) | Face cutscene key for this entity, or null if no default is defined | (this) |
