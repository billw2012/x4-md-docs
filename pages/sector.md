...
| `averagedistancetolockbox` | [`length`](./length.html) | Average distance to a lockbox from any point in this sector. (-1m if not possible to get a lockbox in this sector) | (this) |
| `averagemaxyield` | [`wareamountlist`](./wareamountlist.html) | Average maximum yields of resources in the sector | (this) |
| `iscontested` | [`boolean`](./boolean.html) | True iff there are two or more factions currently vying for ownership of the sector | (this) |
| `iscontestedby.{$faction}` | [`boolean`](./boolean.html) | True iff sector is contested by specified faction | (this) |
| `contestingfactions` | [`list`](./list.html) | List of factions contesting this sector | (this) |
| `hasgravidarobscuringregion` | [`boolean`](./boolean.html) | True if the sector has a gravidar obscuring region. | (this) |
| `gravidarfactorat.{$position}` | [`float`](./float.html) | Gravidar factor at the given sector position | (this) |
| `hashazardousregion` | [`boolean`](./boolean.html) | True if the sector has a hazardous region. | (this) |
| `hashazardousregionat.{$position}` | [`boolean`](./boolean.html) | Whether the given sector position is inside a hazardous region | (this) |
| `isregioncurrentlyhazardousat.{$position}` | [`boolean`](./boolean.html) | Whether the given sector position is inside a region that is currently hazardous | (this) |
| `resources` | [`warelist`](./warelist.html) | All region resource wares | (this) |
| `containsthewave` | [`boolean`](./boolean.html) | True if the sector is flagged to contain The Wave anomaly | (this) |
| `waveprotectionresources` | [`warelist`](./warelist.html) | Wares required for an object to be protected from The Ware anomaly. 1 unit of each ware is required for protection. | (this) |
| `policefaction` | [`faction`](./faction.html) | Police faction for this sector, which is the police faction of the sector owner (may be null) | (this) |
| `typicallockboxmacro` | [`macro`](./macro.html) | Macro of a lockbox typically found in this sector | (this) |
| `coreposition` | [`position`](./position.html) | The center position of the area considered the core of the sector, in sector coordinates | (this) |
| `coresize` | [`length`](./length.html) | The diameter of the area considered the core of the sector | (this) |
