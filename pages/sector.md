...
| `averagemaxyield` | [`wareamountlist`](./wareamountlist.html) | Average maximum yields of resources in the sector |
| `iscontested` | [`boolean`](./boolean.html) | True iff there are two or more factions currently vying for ownership of the sector |
| `iscontestedby.{$faction}` | [`boolean`](./boolean.html) | True iff sector is contested by specified faction |
| `contestingfactions` | [`list`](./list.html) | List of factions contesting this sector |
| `hasgravidarobscuringregion` | [`boolean`](./boolean.html) | True if the sector has a gravidar obscuring region. |
| `gravidarfactorat.{$position}` | [`float`](./float.html) | Gravidar factor at the given sector position |
| `hashazardousregion` | [`boolean`](./boolean.html) | True if the sector has a hazardous region. |
| `hashazardousregionat.{$position}` | [`boolean`](./boolean.html) | Whether the given sector position is inside a hazardous region |
| `isregioncurrentlyhazardousat.{$position}` | [`boolean`](./boolean.html) | Whether the given sector position is inside a region that is currently hazardous |
| `resources` | [`warelist`](./warelist.html) | All region resource wares |
| `containsthewave` | [`boolean`](./boolean.html) | True if the sector is flagged to contain The Wave anomaly |
| `waveprotectionresources` | [`warelist`](./warelist.html) | Wares required for an object to be protected from The Ware anomaly. 1 unit of each ware is required for protection. |
| `policefaction` | [`faction`](./faction.html) | Police faction for this sector, which is the police faction of the sector owner (may be null) |
