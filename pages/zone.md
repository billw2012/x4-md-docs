...
| `adjacentzones` | [`list`](./list.html) | List of adjacent zones | (this) |
| `haspriority` | [`boolean`](./boolean.html) | true iff zone has highest priority in its area. false for highways | (this) |
| `policefaction` | [`faction`](./faction.html) | Police faction for this zone, which is the police faction of the zone owner (may be null) | (this) |
| `istempzone` | [`boolean`](./boolean.html) | true iff temporary zone | (this) |
| `isnormalzone` | [`boolean`](./boolean.html) | true iff normal zone (not temporary, not gate zone and not highway) | (this) |
| `size` | [`length`](./length.html) | Zone size (edge length) | (this) |
| `hashazardousregionat.{$position}` | [`boolean`](./boolean.html) | Whether the given zone position is inside a hazardous region | (this) |
| `isregioncurrentlyhazardousat.{$position}` | [`boolean`](./boolean.html) | Whether the given zone position is inside a region that is currently hazardous | (this) |
